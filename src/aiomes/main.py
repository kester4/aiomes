...
class Client(AsyncClass):
                    ...
                    period_marks.append(
                        TrimesterMarksType(
                            ...
                            marks=[
                                ...
                                for mark in subject["periods"][period_id]["marks"]
                            ],
    ...
    async def get_buffet_menu(self, request_date=date.today()) -> List[BuffetMenuType]:
        """
    ...
    async def get_subjects(self) -> List:
        """
        Получение списка учебных предметов
